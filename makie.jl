...
# ╔═╡ 5cdf4602-083b-11f0-19b9-5d3108cda9ca
begin
...
# ╔═╡ 7402db22-a6c6-4e8b-bedc-3aac10a1d964
...
# ╔═╡ dbb720f5-3c3f-4b13-88ce-50214ff3d362
function build_surface3_makie(;
	...
	Colorbar(fig[1, 2], surf, label = zlabel_latex,)# height = Relative(0.5)

	#save("assets/surface_plot3_$(varying_param).svg", fig)
    fig
end

# ╔═╡ 1b73c1a1-2f63-4703-9c75-9512ed78fad2
build_surface3_makie()

# ╔═╡ 94064b02-ce1c-4440-9297-8470651140b7
build_surface3_makie(
	varying_param=:Ts,
	param_values=range(0.4, 1.0, length=150)
)

# ╔═╡ 2f875ba5-378e-4964-86e7-b1fabecc2621
begin
...
manifest_format = "2.0"
project_hash = "7fa2b451498073903a5369ab8da94f47044004e2"
