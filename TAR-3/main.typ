...
Задача работы заключается в поиске значений параметров корректирующего пассивно-диференцирующнго звена, при которых запас устойчивости скорректированной САР будет повышен до заданных величин, а величина перерегулирования максимально снижена.

Актуальность исследования заключается в анализе возможности повышения качества переходного процесса САР без внесения существеннух изменений в её конструкцию.
...
#figure(
  image("assets/pol_ras_3.png", width: 80%),
  caption: [Гадограф располагаемой САР по набору данных 1]
) <pol_ras_3>

#figure(
  image("assets/pol_cor_3.png", width: 80%),
  caption: [Гадограф скорректированной САР по набору данных 1]
) <pol_ras_3>

#figure(
  image("assets/pol_ras_17.png", width: 80%),
  caption: [Гадограф располагаемой САР по набору данных 2]
) <pol_ras_3>

#figure(
  image("assets/pol_cor_17.png", width: 80%),
  caption: [Гадограф скорректированной САР по набору данных 2]
) <pol_ras_3>

#heading(numbering: none)[Заключение]

Были определены параметры корректирующего пассивно-дифференцирующего звена, обеспечивающие требуемый запас устойчивости по фазе, а также минимизирующие величину перерегулирования. Таким образом, показано, что применение корретирующего звена позволяет повысить устойчивость системы и качество переходного процесса.
