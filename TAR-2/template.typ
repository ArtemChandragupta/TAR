...
#let conf(
  ...
  align(center, text(hyphenate: false)[
    *Министерство науки и высшего образования Российской Федерации*
    ...
    Санкт-Петербургский Политехнический университет Петра Великого \ Институт энергетики \ Высшая школа энергетического машиностроения
    #v(8em)

    *Отчёт по практической работе №#number*\
    ...
    #table(
      ...
      [Студент гр.3231303/21201 п/г 2],
      "_____________", [А. Д. Ярошевич],
    
      [],[],[],
      [Принял:],[],[], [Доцент ВШЭМ],
      "_____________", [В. А. Суханов]
    )
