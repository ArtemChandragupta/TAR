...
#show: conf.with(
  number: 2,
  title: "Редуцирование модели САР паровой турбины до колебательного звена"
)

#heading(outlined:false, numbering:none)[Реферат]

В данной лабораторной работе проведено редуцирование модели системы автоматического регулирования (САР) паровой турбины до одного колебательного звена. Основная цель состояла в поиске параметров этого звена: 

КЛЮЧЕВЫЕ СЛОВА: ПЕРЕХОДНЫЙ ПРОЦЕСС, КОЛЕБАТЕЛЬНОЕ ЗВЕНО.

#outline(title: "СОДЕРЖАНИЕ")

#heading(outlined:false, numbering:none)[Введение]
